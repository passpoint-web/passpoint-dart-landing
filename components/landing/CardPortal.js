...
const CardPortal = () => {
  return (
    <main className="w-[95%] ml-auto flex items-center md:w-[90%] md:mx-auto tab:gap-10 tab:flex-col-reverse">
      <section className="w-[40%] md:w-[50%] tab:w-[70%] sm:w-full">
        <Image src={HeroImage} alt="portal" />
      </section>
      <section className="w-[40%] md:w-[55%] tab:w-full">
        ...
        <div className="flex">
          <ButtonLink
            href="#"
            text="Get Started"
            className="text-primary-2 bg-primary-1"
          />
        </div>
      </section>
    </main>
